...
%sql
select Vendas_itens.id_produto,
round(sum(Vendas_itens.valor_total_sem_desc), 3) as valor_total_sem_desc,
round(sum(Vendas_itens.valor_total_com_desc), 3) as valor_total_com_desc
from Vendas_itens
